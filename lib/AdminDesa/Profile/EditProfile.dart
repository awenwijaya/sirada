...
class _editProfileAdminState extends State<editProfileAdmin> {
  ...
  bool Loading = false;
  var apiURLEditProfile = "http://192.168.122.149:8000/api/data/userdata/edit";
  ...
  Future uploadImage() async {
    final uri = Uri.parse("http://192.168.122.149/siraja-api-skripsi-new/upload-profile-picture.php");
