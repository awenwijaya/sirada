              ...
              child: LoadData ? ProfilePageShimmer() : SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      child: status == "Menunggu Respon" ? Container() : status == "Telah Dikonfirmasi" ? Container() : canValidate == false ? Container(
                          child: Container(
                            child: Row(
                              children: <Widget>[
                                Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    child: FlatButton(
                                      onPressed: (){
                                        Navigator.push(context, CupertinoPageRoute(builder: (context) => tolakValidasiSuratPanitiaAdmin()));
                                      },
