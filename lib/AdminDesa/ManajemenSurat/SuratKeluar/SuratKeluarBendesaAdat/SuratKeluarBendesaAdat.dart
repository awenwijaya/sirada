...
class suratKeluarBendesaAdatAdmin extends StatefulWidget {
  const suratKeluarBendesaAdatAdmin({Key key}) : super(key: key);

  @override
  State<suratKeluarBendesaAdatAdmin> createState() => _suratKeluarBendesaAdatAdminState();
}

class _suratKeluarBendesaAdatAdminState extends State<suratKeluarBendesaAdatAdmin> {
  @override
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text("Surat Bendesa Adat", style: TextStyle(
            fontFamily: "Poppins",
