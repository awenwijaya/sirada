...
class _suratMasukAdminState extends State<suratMasukAdmin> {
  var apiURLShowListSuratMasuk = "http://192.168.122.149:8000/api/data/admin/surat/masuk/${loginPage.desaId}";
  var apiURLDeleteSuratMasuk = "http://192.168.122.149:8000/api/admin/surat/masuk/delete";
  var idSuratMasuk = [];
