...
class _permintaanVerifikasiSuratKeluarAdminState extends State<permintaanVerifikasiSuratKeluarAdmin> {
  ...
  var apiURLShowFilterTimKegiatan = "https://siradaskripsi.my.id/api/verifikasi/surat/prajuru/filter/tim_kegiatan/${loginPage.prajuruId}";
  var apiURLShowFilterStatus = "https://siradaskripsi.my.id/api/verifikasi/surat/prajuru/filter/status/${loginPage.prajuruId}";
  var apiURLShowFilterResult = "https://siradaskripsi.my.id/api/verifikasi/surat/prajuru/filter/result";
