...
class _prajuruBanjarAdatAdminState extends State<prajuruBanjarAdatAdmin> {
  ...
  var apiURLShowListPrajuruBanjarAdatAktif = "http://192.168.122.149:8000/api/data/staff/prajuru_banjar_adat/aktif/${loginPage.desaId}";
  var apiURLShowListPrajuruBanjarAdatTidakAktif =  "http://192.168.122.149:8000/api/data/staff/prajuru_banjar_adat/tidak_aktif/${loginPage.desaId}";
  var apiURLDeletePrajuruBanjarAdat = "http://192.168.122.149:8000/api/admin/prajuru/banjar_adat/delete";
  var apiURLSetPrajuruBanjarTidakAktif = "http://192.168.122.149:8000/api/admin/prajuru/banjar_adat/set_tidak_aktif";
