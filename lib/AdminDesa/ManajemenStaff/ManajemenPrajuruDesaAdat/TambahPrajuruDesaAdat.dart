...
class _tambahPrajuruDesaAdatAdminState extends State<tambahPrajuruDesaAdatAdmin> {
  ...
  var pegawaiID;
  var selectedRole;
  var apiURLUpDataPrajuruDesaAdat = "http://172.16.58.41:8000/api/admin/prajuru/desa_adat/up";
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      child: FlatButton(
                        onPressed: () async {
                          if(selectedStatus == null || selectedJabatan == null || selectedMasaBerakhirValue == null || selectedMasaMulaiValue == null || kramaMipilID == null || controllerEmail.text == "" || file == null) {
                            showDialog(
                              context: context,
...
class _pilihDataPegawaiState extends State<pilihDataPegawai> {
  var apiURLGetDataPenduduk = "http://172.16.58.41:8000/api/data/penduduk/desa_adat/${loginPage.desaId}";
  var nikPegawai = [];
  var namaPegawai = [];
  var kramaMipilID = [];
  var pegawaiID = [];
