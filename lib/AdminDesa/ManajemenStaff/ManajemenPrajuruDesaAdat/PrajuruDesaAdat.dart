...
class _prajuruDesaAdatAdminState extends State<prajuruDesaAdatAdmin> {
  ...
  var apiURLShowListPrajuruDesaAdatAktif = "http://192.168.239.149:8000/api/data/staff/prajuru_desa_adat/aktif/${loginPage.desaId}";
  var apiURLShowListPrajuruDesaAdatTidakAktif = "http://192.168.239.149:8000/api/data/staff/prajuru_desa_adat/tidak_aktif/${loginPage.desaId}";
  var apiURLDeletePrajuruDesaAdat = "http://192.168.239.149:8000/api/admin/prajuru/desa_adat/delete";
  var apiURLSetPrajuruTidakAktif = "http://192.168.239.149:8000/api/admin/prajuru/desa_adat/set_tidak_aktif";
