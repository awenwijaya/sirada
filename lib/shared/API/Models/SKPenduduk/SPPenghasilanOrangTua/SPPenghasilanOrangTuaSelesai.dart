...
//
//     final spPenghasilanOrangTuaSelesai = spPenghasilanOrangTuaSelesaiFromJson(jsonString);

import 'dart:convert';

SpPenghasilanOrangTuaSelesai spPenghasilanOrangTuaSelesaiFromJson(String str) => SpPenghasilanOrangTuaSelesai.fromJson(json.decode(str));

String spPenghasilanOrangTuaSelesaiToJson(SpPenghasilanOrangTuaSelesai data) => json.encode(data.toJson());

class SpPenghasilanOrangTuaSelesai {
  SpPenghasilanOrangTuaSelesai({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory SpPenghasilanOrangTuaSelesai.fromJson(Map<String, dynamic> json) => SpPenghasilanOrangTuaSelesai(
    status: json["status"],
