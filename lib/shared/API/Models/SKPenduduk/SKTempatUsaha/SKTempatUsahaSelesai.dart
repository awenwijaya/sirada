...
//
//     final skTempatUsahaSelesai = skTempatUsahaSelesaiFromJson(jsonString);

import 'dart:convert';

SkTempatUsahaSelesai skTempatUsahaSelesaiFromJson(String str) => SkTempatUsahaSelesai.fromJson(json.decode(str));

String skTempatUsahaSelesaiToJson(SkTempatUsahaSelesai data) => json.encode(data.toJson());

class SkTempatUsahaSelesai {
  SkTempatUsahaSelesai({
    this.status,
    this.message,
    this.data,
  });
  ...
  factory SkTempatUsahaSelesai.fromJson(Map<String, dynamic> json) => SkTempatUsahaSelesai(
    status: json["status"],
