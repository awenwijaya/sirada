...
class _suratDiterimaPrajuruBanjarState extends State<suratDiterimaPrajuruBanjar> {
  ...
  var apiURLGetFilterKegiatan = "https://siradaskripsi.my.id/api/surat/tetujon/prajuru-banjar/filter/${suratDiterimaPrajuruBanjar.prajuruId}";
  var apiURLShowFilterResult = "https://siradaskripsi.my.id/api/surat/tetujon/prajuru-banjar/filter/result";
  ...
  Future getFilterKomponen() async {
    http.get(Uri.parse(apiURLGetFilterKegiatan),
        headers: {"Content-Type" : "application/json"}
