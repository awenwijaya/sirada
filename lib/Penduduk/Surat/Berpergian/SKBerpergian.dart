...
class SKBerpergian extends StatefulWidget {
  const SKBerpergian({Key key}) : super(key: key);

  @override
  _SKBerpergianState createState() => _SKBerpergianState();
}

class _SKBerpergianState extends State<SKBerpergian> {
  @override
            ...
            children: <Widget>[
              ...
              Container(
                child: FlatButton(
                  ...
                  child: Text('Ajukan SK Berpergian', style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    color: HexColor("#025393"),
                    fontWeight: FontWeight.w700
              ...
              Container(
                ...
                child: Text(
                  "Status Pengajuan SK Berpergian",
                  style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    fontWeight: FontWeight.w700
