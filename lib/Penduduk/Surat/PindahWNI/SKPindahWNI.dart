...
class SKPindahWNI extends StatefulWidget {
  const SKPindahWNI({Key key}) : super(key: key);

  @override
  _SKPindahWNIState createState() => _SKPindahWNIState();
}

class _SKPindahWNIState extends State<SKPindahWNI> {
  @override
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                child: FlatButton(
                  onPressed: (){},
                  child: Text("Ajukan SK Pindah WNI", style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    fontWeight: FontWeight.w700,
                    color: HexColor("#025393")
              ...
              Container(
                ...
                child: Text(
                  "Status Pengajuan SK Pindah WNI",
                  style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    fontWeight: FontWeight.w700
