...
class SKKematian extends StatefulWidget {
  const SKKematian({Key key}) : super(key: key);

  @override
  _SKKematianState createState() => _SKKematianState();
}

class _SKKematianState extends State<SKKematian> {
  @override
            ...
            children: <Widget>[
              ...
              Container(
                child: FlatButton(
                  ...
                  child: Text('Ajukan SK Kematian', style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    color: HexColor("#025393"),
                    fontWeight: FontWeight.w700
