...
class SKDatangWNI extends StatefulWidget {
  const SKDatangWNI({Key key}) : super(key: key);

  @override
  _SKDatangWNIState createState() => _SKDatangWNIState();
}

class _SKDatangWNIState extends State<SKDatangWNI> {
  @override
            ...
            children: <Widget>[
              ...
              Container(
                child: FlatButton(
                  ...
                  child: Text("Ajukan SK Datang WNI", style: TextStyle(
                    fontFamily: "Poppins",
                    fontWeight: FontWeight.w700,
                    fontSize: 14,
                    color: HexColor("#025393")
              ...
              Container(
                ...
                child: Text(
                  "Status Pengajuan SK Datang WNI",
                  style: TextStyle(
                    fontFamily: "Poppins",
                    fontSize: 14,
                    fontWeight: FontWeight.w700
