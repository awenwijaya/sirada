...
class agendaAcaraPanitia extends StatefulWidget {
  static var selectedView = "Bulan";
  const agendaAcaraPanitia({Key key}) : super(key: key);

  @override
  State<agendaAcaraPanitia> createState() => _agendaAcaraPanitiaState();
}

class _agendaAcaraPanitiaState extends State<agendaAcaraPanitia> {
  List view = ['Hari', 'Minggu', 'Bulan'];
  EventController eventController;
  var apiURLGetAgenda = "https://siradaskripsi.my.id/api/agenda/${loginPage.kramaId}/panitia";

  Future getAgendaPanitia() async {
                  ...
                  Flexible(
                      child: Container(
                        ...
                        child: DropdownButton(
                          ...
                          value: agendaAcaraPanitia.selectedView,
                          underline: Container(),
                          items: view.map((e) {
                          ...
                          onChanged: (value) {
                            setState(() {
                              agendaAcaraPanitia.selectedView = value;
                            });
                          },
                        ),
                      )
            ...
            Container(
              child: Expanded(
                child: CalendarControllerProvider(
                  ...
                  child: agendaAcaraPanitia.selectedView == "Bulan" ? MonthView(
