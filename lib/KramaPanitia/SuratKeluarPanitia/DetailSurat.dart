    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            status == "Sedang Diproses" ? validasiSekretarisStatus == "Belum Divalidasi" ? IconButton(
              onPressed: (){
                showDialog(
                  context: context,
              ...
              child: LoadData ? ProfilePageShimmer() : SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Container(
                      child: status == "Menunggu Respon" ? Container() : status == "Dibatalkan" ? Container() : canValidate == false ? Container(
                          child: Container(
                            child: Row(
                              children: <Widget>[
                                Container(
