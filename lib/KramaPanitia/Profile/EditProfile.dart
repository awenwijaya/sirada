...
class editProfileKramaPanitia extends StatefulWidget {
  const editProfileKramaPanitia({Key key}) : super(key: key);

  @override
  State<editProfileKramaPanitia> createState() => _editProfileKramaPanitiaState();
}

class _editProfileKramaPanitiaState extends State<editProfileKramaPanitia> {
  ...
  String selectedAgama = kramaPanitiaProfile.agamaPenduduk;
  ...
  void initState() {
    ...
    super.initState();
    controllerUsername = new TextEditingController(text: kramaPanitiaProfile.usernamePenduduk);
